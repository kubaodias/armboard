   ...
   0x00200000 -work-area-size 0x4000 -work-area-backup 1
		...
		\section{Bootloader}
			...
			\subsection{Bootloader główny}
				...
				Po pobraniu z internetu i poprawnym skompilowaniu za pomocą polecenia \texttt{make} przystąpiono do dostosowywania aplikacji do potrzeb docelowej platformy sprzętowej. W tym celu skopiowano zawartość przykładowego projektu zawartego w katalogu \texttt{board/atmel/at91rm9200dk} do katalogu \texttt{board/atmel/lab\_at91rm9200} i w dalszej kolejności wykonano następujące czynności:
				\begin{enumerate}
					...
					\item Dodano wpis dla platformy \texttt{lab\_at91rm9200} w głównym pliku \texttt{Makefile} projektu U-Boot.
				\end{enumerate}
